...
abstract class Publication 
{
  public abstract void PublishDetails();
    ...
    class Article
    {
		...
		protected TypeArticle type;

        public Article(double prix, string designation,  TypeArticle type)
        {
            this.prix = prix;
            this.designation = designation;
			this.type=type;
        }
		static double pourcentage(Article i) { return i.prix*0.3; }
		static double from_type(Article i) { return (double) i.type; }
		delegate double operation(Article i);
		static operation[] ops = new operation[2] { Article.pourcentage, Article.from_type};
		
		public static double calcule(Article i, int op)
		{
			return Article.ops[op](i);
		}
    ...
    class Livre : Article
    {
        ...
        public Livre(int nb_page, double prix, string designation,TypeArticle type)
            : base(prix, designation, type)
        {
    ...
    class Poche : Livre
    {
        ...
        public Poche(int nb_page, double prix, string designation, string categorie, TypeArticle type)
            : base(nb_page, prix, designation, type)
        {
...
// Introduit les fonctionnalités de System :
    ...
    class MonApp
    {
        public static void Main()
        {
			...
			Livre ezar= new Livre(10,1,"fds",TypeArticle.Loisir);
			Console.WriteLine(Article.calcule(ezar,0));
